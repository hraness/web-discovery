---
title: Web Discovery knowledge base
aliases:
...
This Git-backed Markdown vault is durable memory for Web Discovery. Open `kb/` itself as the vault. Markdown and Git are authoritative. Catalogs, backlinks, graph views, semantic indexes, repository context, and Git projections are derived.
...
The [[scopes/repository--cdb4ee2aea69|repository context hub]] explains repository-wide rule boundaries. [[notes/documentation-ownership|Documentation ownership]] records the durable split between guides, executable contracts, and KB context. [[notes/repository-seams|Repository seams]] records which interfaces may cross repository boundaries.
